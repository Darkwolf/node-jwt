...
const getUnixTimestamp = () => DateNow() / 1e3 | 0

const toUnixTimestamp = value => {
  value = TypesToIntegerOrInfinity(InstancesIsDate(value) ? DatePrototypeGetTime(value) / 1e3 : value)
  if (value < 0) {
...
ObjectDefineProperties(JWTError, {
  isJWTError: {
    value: isJWTError
  }
})
